...
=== 投資の心得
実験に移る前に，投資，特にシステムトレードをする際の基本的な心構えについて触れておこう．いくつかのシステムトレードや株式トレードに関する本を読んだが，重要なものを幾つかピックアップする．

* 100%勝つなんてことはあり得ない いかにして損失を抑えるかが重要であり，少額の損失で切るのがプロフェッショナル
* 投資をする際に最も障壁となるのは感情であり，感情をコントロールするのが成功の鍵
