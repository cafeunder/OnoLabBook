...
などの欲がどうしても出てしまい判断が狂ってしまいがちなのだ．自動トレードシステムを構築すれば，そういった要素を一切排除できるのも魅力である．

== 実験
前で述べたアルゴリズムを使って，実際の為替市場で通用するかを確かめてみよう．

=== 使用するデータ
使用するデータは#todoから取得できるUSD/JPYの2007年から2016年のデータとする．サイトから取得できるデータは1分足データであるが，
これを10分足に加工し，この時間軸でテクニカル指標のデータを生成した．10分足データにした理由は，ノイズを除去するためである．


=== 実験設定
実験で用いるパラメータを#todoに示す．

=== 実験結果
30世代計算終了後の最良個体を次に示す．初めて見た人はなんじゃこりゃと思うだろう．個々のテクニカル指標は置いといて，とりあえずめっちゃ長い文字列となっている．これは，GPのブロートという現象
