...
=== 実験設定
今回はUSD/JPYを買いのみ行い，GPの個体によって得られるタイミングで買ってから，100分(=10分足 × 10本)だけ保持したら必ず売るという方法を取る．短気なのにバイ・アンド・ホールド
...
点である．これは，「1回の取引で損することは多いが損失は少なく，利益は大きい」という戦略になっているということが言えよう．売る際の条件を適当にしたにも関わらず，このような結果と
なったのは少々意外であった．
...
== おわりに
この記事では，進化戦略の一種である遺伝的プログラミングを用いてFXの売買に挑んだ．実験により，過去10年で通用する戦略を生み出すことができることが確認された．
