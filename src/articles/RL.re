...
//footnote[sapga][http://ieeexplore.ieee.org/ abstract/document/1554988/]
...
//image[term1][学習スタート直後のエージェントのプレイの様子][scale=1.3]
//image[term2][学習終盤のエージェントのプレイの様子][scale=1.3]
...
この辺について，何かいいアイデアや知識をお持ちの方は，ぜひぜひご享受くださいm(_ _)m．
...
//footnote[git][https://github.com/ bakanaouji/MyRL]
一時はC#で実装していましたが，学習におそろしく時間がかかったため断念し，Javaへと移植しました．
そのうちC++実装に切り替えるかも知れません．
高速な言語ほどいいものはないです．
