...
今回は，とあるバーチャルシンガーのイラストとロゴを点描に変換してインスタンスを生成しています@<fn>{fn_gomen}．
//footnote[fn_gomen][本記事では，権利的に画像を載せることができませんが，後述するGitHubにて経路の画像を公開しています．]
...
またの機会があれば，上記に関して筆を取らせて頂きたいと思います．
