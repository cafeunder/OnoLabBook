...
本章では，4.2節で四足歩行ロボットのモデルを示します．4.3節で四足歩行ロボットの制御方法について説明します．4.4節で最適化手法である，NES と Adam について説明します．4.5節で四足歩行ロボットの歩行学習の手順とそれぞれの最適化手法における歩行学習結果を示します．4.6節で本章をまとめます．
